...
// HSLA is kept in instances for gpui consistency; we convert HSLA→RGBA here
// per-vertex. If profiling shows vertex pressure at very large instance counts,
// consider precomputing RGBA on CPU or packing RGBA8 in the instance.
...
// formats aligned with gpui. A packed RGBA8 path is a possible future
// optimization if bandwidth becomes a bottleneck.
